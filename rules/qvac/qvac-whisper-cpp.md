---
name: qvac-whisper-cpp
description: Testing and verification requirements for qvac-fabric-speech.cpp (formerly qvac-ext-lib-whisper.cpp) changes
globs: "**/qvac-fabric-speech.cpp/**,**/qvac-ext-lib-whisper.cpp/**"
alwaysApply: false
---
